...
export default function ProfilePage({ user, onLogout, onLogin, onDeleted, onAvatarChange }) {
  ...
  async function changePassword() {
    ...
    if (authError) { setPwdError("Current password is incorrect."); setPwdLoading(false); return; }
            ...
            <div style={{ marginTop: 16, paddingTop: 16, borderTop: `1px solid ${TM}` }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <input type="password" value={currentPwd} onChange={e => setCurrentPwd(e.target.value)}
                  placeholder="Current password" style={{ padding: "9px 14px", borderRadius: 12, border: `1.5px solid ${TM}`, fontSize: 14, fontFamily: "inherit", outline: "none" }} />
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  ...
                  <button onClick={() => { setChangingPwd(false); setCurrentPwd(""); setNewPwd(""); setConfirmPwd(""); setPwdError(""); }}
